...
test-noros: clean
	...
	${MAKE} clangcheck SCANBUILD=scan-build-20 OPTIONS=noros_tidy
	${MAKE} cppcheck
	${MAKE} spell
...
install-deps:
	...
	${APT_INSTALL} octave libpugixml-dev libyaml-cpp-dev rapidjson-dev libmsgpack-dev graphviz nlohmann-json3-dev python3-numpy
