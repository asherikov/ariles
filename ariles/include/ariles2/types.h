...
namespace ariles2
{
    ...
    class Any : public ariles2::DefaultBase
    {
...
{
    template <template <class> class t_Pointer, class t_Base, class t_Instantiator>
    class Any2 : public ariles2::DefaultBase
    {
#define ARILES2_ENTRIES(v)                                                                                             \
    ARILES2_TYPED_ENTRY_(v, id, std::string)                                                                           \
    ARILES2_TYPED_ENTRY_(v, value, t_Pointer<t_Base>)
...
namespace ariles2
{
    ...
    template <class t_Pointer>
    class NonNullPointer : public CustomPointerBase<t_Pointer>, public ariles2::DefaultBase
    {
#include ARILES2_INITIALIZE
    ...
    template <class t_Pointer>
    class OptionalPointer : public CustomPointerBase<t_Pointer>, public ariles2::DefaultBase
    {
#include ARILES2_INITIALIZE
