...
namespace ariles2
{
    ...
    namespace cfgread
    {
        ...
        class Visitor : public aggregate::Visitor<cfgread::Visitor<t_Reader>, Defaults, t_Reader, Finalize>
        {
        public:
...
namespace ariles2
{
    ...
    namespace cfgwrite
    {
        ...
        class Visitor : public aggregate::Visitor<cfgwrite::Visitor<t_Writer>, PreWrite, t_Writer>
        {
        public:
