...
namespace ariles2
{
    ...
    namespace write
    {
        class Parameters : public serialization::Parameters
        {
        public:
        ...
        class VisitorBase : public serialization::Base<t_Derived, t_Parameters>
        {
        public:
...
#undef ARILES2_BASIC_TYPE
        ...
        class Visitor : public VisitorBase<Visitor, Parameters>
        {
        protected:
            Visitor() = default;
            ~Visitor() = default;
