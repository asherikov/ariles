...
#include "fixtures/025_comparison_partial.h"
...
#define ARILES_TESTS(VISITOR_ID, NAMESPACE, INITIALIZER)                                                               \
    BOOST_FIXTURE_TEST_CASE(                                                                                           \
            PartialEquivalenceFixture##_##VISITOR_ID##_##INITIALIZER,                                                  \
            ariles_tests::PartialEquivalenceFixture<ariles_tests::initializers::INITIALIZER>)                          \
    {                                                                                                                  \
        test<ariles_tests::Partial, ariles_tests::Complete, ariles2::NAMESPACE>();                                     \
    }
