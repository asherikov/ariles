...
#include "fixtures/024_write_python.h"
...
#define ARILES_TESTS(VISITOR_ID, NAMESPACE, INITIALIZER)                                                               \
    ARILES_FIXTURE_TEST_CASE(PythonFixture, VISITOR_ID, NAMESPACE, ConfigurableComplex, INITIALIZER)                   \
    ARILES_FIXTURE_TEST_CASE(PythonFixture, VISITOR_ID, NAMESPACE, ConfigurablePointers, INITIALIZER)
