    ...
    protected:
        ...
        void test()
        {
            ...
            BOOST_CHECK_EQUAL(
                    ...
                    configurable.arilesGetParameters(writer.template get<ariles2::write::Visitor>()).sloppy_maps_);
            BOOST_CHECK_EQUAL(
                    configurable.getExpectedWriteParameters().sloppy_pairs_,
                    configurable.arilesGetParameters(writer.template get<ariles2::write::Visitor>()).sloppy_pairs_);
            ...
            BOOST_CHECK_EQUAL(
                    ...
                    configurable.arilesGetParameters(reader.template get<ariles2::read::Visitor>()).sloppy_maps_);
            BOOST_CHECK_EQUAL(
                    configurable.getExpectedReadParameters().sloppy_pairs_,
                    configurable.arilesGetParameters(reader.template get<ariles2::read::Visitor>()).sloppy_pairs_);
        }
    };
}  // namespace ariles_tests
