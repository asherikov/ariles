...
{
    class ConfigurableComplexSloppy : public ariles2::RelaxedSloppyBase,
                                      public ConfigurableComplexBase<ConfigurableComplexSloppy>
    {
...
#undef ARILES2_ENTRIES_1
    ...
    public:
        ConfigurableComplexSloppy()
        {
            ariles2::apply<ariles2::Defaults>(*this);
        }

        virtual ~ConfigurableComplexSloppy()
        {
        }

        void arilesVisit(const ariles2::Defaults &visitor, const ariles2::Defaults::Parameters &param)
        {
            ConfigurableComplexBase<ConfigurableComplexSloppy>::arilesVisit(visitor, param);
        }
    };
}  // namespace ariles_tests
