...
#define ARILES_TESTS(VISITOR_ID, NAMESPACE, INITIALIZER)                                           \
    ...
    ARILES_FIXTURE_TEST_CASE(                                                                      \
            BasicInterfaceFixture, VISITOR_ID, NAMESPACE, ConfigurableNoConstructors, INITIALIZER) \
    ARILES_FIXTURE_TEST_CASE(                                                                      \
    ...
    ARILES_FIXTURE_TEST_CASE(                                                                      \
            ConstructorInterfaceFixture, VISITOR_ID, NAMESPACE, ConfigurableVerbose, INITIALIZER)  \
    ARILES_FIXTURE_TEST_CASE(                                                                      \
            ConstructorInterfaceFixture,                                                           \
            VISITOR_ID,                                                                            \
            NAMESPACE,                                                                             \
