            ...
            {
                {
                    ...
                    BOOST_CHECK_NO_THROW(
                        configurable_out.template ariles<typename t_Bridge::Writer>(getWriterInitializer("configurable_match_member_definitions.cfg"), "Configurable");
                    );
                    ...
                    BOOST_CHECK_NO_THROW(
                        configurable_in.template ariles<typename t_Bridge::Reader>(getReaderInitializer("configurable_match_member_definitions.cfg"), "Configurable");
                    );
