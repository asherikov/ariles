...
#define ARILES_FIXTURE_TEST_CASE(FIXTURE_NAME, FORMAT_NAMESPACE, CONFIGURABLE_TYPE, INITIALIZER_TYPE) \
    BOOST_FIXTURE_TEST_CASE( FIXTURE_NAME##_##FORMAT_NAMESPACE##_##CONFIGURABLE_TYPE##_##INITIALIZER_TYPE, FIXTURE_NAME<initializers::INITIALIZER_TYPE> ) \
    { \
        test<CONFIGURABLE_TYPE, ariles::FORMAT_NAMESPACE>(); \
    }

#define ARILES_FIXTURE_TEST_CASE_2CLASSES(FIXTURE_NAME, FORMAT_NAMESPACE, CONFIGURABLE_TYPE1, CONFIGURABLE_TYPE2, INITIALIZER_TYPE) \
    BOOST_FIXTURE_TEST_CASE( FIXTURE_NAME##_##FORMAT_NAMESPACE##_##CONFIGURABLE_TYPE1##_##CONFIGURABLE_TYPE2##_##INITIALIZER_TYPE, FIXTURE_NAME<initializers::INITIALIZER_TYPE> ) \
    { \
