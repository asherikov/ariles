...
#define ARILES_FIXTURE_TEST_CASE_2CLASSES(FIXTURE_NAME, FORMAT_NAMESPACE, CONFIGURABLE_TYPE1, CONFIGURABLE_TYPE2) \
    BOOST_FIXTURE_TEST_CASE( FIXTURE_NAME##_##FORMAT_NAMESPACE##_##CONFIGURABLE_TYPE1##_##CONFIGURABLE_TYPE2, FIXTURE_NAME ) \
    { \
        test<CONFIGURABLE_TYPE1, CONFIGURABLE_TYPE2, ariles::FORMAT_NAMESPACE::Reader, ariles::FORMAT_NAMESPACE::Writer>(); \
    }
